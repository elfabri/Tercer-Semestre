...
public class TestEnumeraciones {
    public static void main( String[] args) {
        ...
        System.out.println("No. de paises en el 2do continente: " + Continentes.AMERICA.getPaises());
        System.out.println("No. de habitantes en el 2do continente: " + Continentes.AMERICA.getHabitantes());
        ...
        System.out.println("No. de paises en el 4to continente: " + Continentes.EUROPA.getPaises());
